...
class InputNumericCell : public DetailCell
{
  public:
    ...
    void init(std::string title, long value, Event<long>::Callback callback, std::string hint = "", int maxInputLength = 18, int kbdDisableBitmask = 0, std::string imgpath = "sdmc:/SplatEditor/Cache/test.png");
    ...
    void setThumbnail(std::string imgPath);
    void setThumbnail(unsigned char* buffer, size_t bufferSize);

    void setThumbnailwithSize(std::string imgPath, float width, float height);
