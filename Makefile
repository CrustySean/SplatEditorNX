...
DATA				:=	data
INCLUDES			:=	include libs/mbedtls/library include/core libs/mbedtls/include include/splat include/UI libs/json/include/nlohmann libs/starlight/include
